...
%% Conference Deaf
-define(DEAF_PARTICIPANT_HEADERS, [<<"Application-Name">>, <<"Conference-ID">>]).
-define(OPTIONAL_DEAF_PARTICIPANT_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
-define(OPTIONAL_PARTICIPANT_ENERGY_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
-define(OPTIONAL_KICK_HEADERS, [<<"Participant">>, <<"Call-ID">>]).
...
%% Conference Mute
-define(MUTE_PARTICIPANT_HEADERS, [<<"Application-Name">>, <<"Conference-ID">>]).
-define(OPTIONAL_MUTE_PARTICIPANT_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
-define(OPTIONAL_STOP_PLAY_HEADERS, [<<"Participant">>, <<"Call-ID">>, <<"Affects">>]).
...
%% Conference Undeaf
-define(UNDEAF_PARTICIPANT_HEADERS, [<<"Application-Name">>, <<"Conference-ID">>]).
-define(OPTIONAL_UNDEAF_PARTICIPANT_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
%% Conference Unmute
-define(UNMUTE_PARTICIPANT_HEADERS, [<<"Application-Name">>, <<"Conference-ID">>]).
-define(OPTIONAL_UNMUTE_PARTICIPANT_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
-define(OPTIONAL_PARTICIPANT_VOLUME_IN_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
...
-define(OPTIONAL_PARTICIPANT_VOLUME_OUT_HEADERS, [<<"Call-ID">>, <<"Participant">>]).
